...
namespace DouImp
{
    public class Rpt_EmpPPtNew : ReportClass
    {
        /// <summary>
        /// 匯出新人簡報
        /// </summary>
        ...
        public string Export(List<string> fnos, string ext)
        {
            ...
            try
            {
                ...
                reportViewer.LocalReport.ReportPath = System.Web.HttpContext.Current.Server.MapPath("~/Report/EmpPPtNew/Master.rdlc");
                ...
                string fileName = "新人簡報_" + DateFormat.ToDate1(DateTime.Now) + "_" + Guid.NewGuid().ToString().Substring(0, 5) + ext;  //"ext=.docx"
